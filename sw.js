/* ============================================================
   ...
   Los datos de SINDI viven en el servidor (no en el dispositivo): la app
   abre sin conexión (el cascarón está en caché) pero necesita internet
...
// Notificaciones locales (eventos y tareas de hoy): al tocarlas, se enfoca
// la pestaña de SINDI ya abierta o, si no hay ninguna, se abre una nueva.
...
self.addEventListener('fetch', event => {
  ...
  // (/api/file, en cambio, sí puede cachearse: cada archivo tiene una key única.)
