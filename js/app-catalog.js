      ...
      <div class="station-group-head" style="align-items:flex-start; flex-wrap:wrap;">
        <div style="display:flex; align-items:center; gap:12px; min-width:0;">
          ${levelPlan && levelPlan.url
            ? `<a href="${esc(levelPlan.viewUrl || levelPlan.url)}" target="_blank"><img src="${esc(levelPlan.url)}" alt="Plano de ${esc(spaceLevelLabel(level))} — ${esc(station.name)}" style="width:60px;height:60px;object-fit:cover;border:1px solid var(--line);border-radius:6px;display:block;"></a>`
            : `<div style="width:60px;height:60px;border-radius:6px;background:#eeece5;flex:0 0 auto;"></div>`}
