...
/* ---- SOLICITUD DE COMPRA (PDF) ----
   Esta pieza NO es la orden de compra en sí (esa la emite Jefatura):
   es la solicitud que se eleva, con los datos del proyecto de origen,
...
function printPurchase(purchaseId){
  ...
  target.innerHTML = `
    ...
    <div class="print-section">
      ...
      <p class="print-obs">Este documento es una <strong>solicitud de compra</strong> elevada a Jefatura. La orden de compra propiamente dicha la emite Jefatura a partir de esta solicitud.</p>
    </div>
    ${p ? `
    <div class="print-section">
